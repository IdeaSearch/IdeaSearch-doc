  ...
  return (
    <main className="physics-directory relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-5 py-8 text-foreground sm:px-8">
      ...
      <div className="absolute right-5 top-5 z-10 sm:right-8 sm:top-8">
        <Link
          href={languageHref}
          className="rounded-full border border-foreground/15 bg-white/45 px-4 py-2 text-sm font-medium backdrop-blur transition hover:bg-white/75 dark:bg-white/10 dark:hover:bg-white/20"
        >
          {text.language}
        </Link>
      </div>
